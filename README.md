...
[![IaC Bazaar: live-tested](https://www.iac-bazaar.com/api/artifacts/azure-private-dns/badge)](https://www.iac-bazaar.com/catalog/azure-private-dns?utm_source=syndication&utm_medium=readme&utm_campaign=artifact)
...
```
curl -s https://www.iac-bazaar.com/api/artifacts/azure-private-dns/verification
```

The receipt names every check that ran, when it ran, and the SHA-256 of the
archive it describes. Full detail: [www.iac-bazaar.com/catalog/azure-private-dns](https://www.iac-bazaar.com/catalog/azure-private-dns)

## Usage

```hcl
module "private_dns" {
  source  = "registry.terraform.io/CyberCoreSystems/private-dns/azurerm"
  version = "~> 1.0"
...
- Terraform module 1.0.0, live-tested on IaC Bazaar: [Azure Private DNS Zone](https://www.iac-bazaar.com/catalog/azure-private-dns?utm_source=syndication&utm_medium=readme&utm_campaign=artifact)
